...
export default async function LegacyStatsPage({ params, searchParams }: LegacyStatsPageProps) {
  const resolvedParams = await Promise.resolve(params)
  const resolvedSearchParams = await Promise.resolve(searchParams ?? {})
  const nextPath = buildBabyScopedPath(resolvedParams.babyId, '/activities')
