...
3. 时间解析规则：
   ...
   - 【具体时间解析 - 非常重要】：
     * 如果用户说具体时间如"8点"、"8点10分"、"上午9点"，应该解析为当天的早上八点或晚上八点，取当前时间往前第一个符合的时间
     * "8点10分到9点" 表示从 08:10 开始，duration = 50 分钟
     * "下午3点到4点半" 表示从 15:00 开始，duration = 90 分钟
     * 注意：在有具体日期的情况下，如昨天，或者 1 月 20 号，中文说"8点"指的是上午8:00，不要错误地理解为下午
     * 如果用户没说"下午"或"晚上"，早上6点到12点的时间默认是上午或早上，12点到18点默认是下午，18点到24点默认是晚上，24点到6点默认是夜里或凌晨
